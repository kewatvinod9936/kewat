            ...
            <div class="col-md-8">
                ...
                <div class="post">
                    ...
                    <div class="post-title">
                        ...
                        <div class="col-md-9"><p>Written By : <span><?php echo $author;?> </span></p>
                    </div>
...
<!--                    <div class="col-md-6"></div>
                    ...
                    <p class="desc"><?php echo $post_data;?></p>
                    <div class="bottom">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(empty($cs_name) or empty($cs_email) or empty($cs_comment)){
                        ...
                        $cs_query = "INSERT INTO `comments` (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES (NULL, '$cs_date', '$cs_name', 'user', '$post_id', '$cs_email', '$cs_website', 'vinod.png', '$cs_comment', 'pending');";
                        if(mysqli_query($con, $cs_query)){
                            $msg = "Comment Submited Wait for Approval";
                                 $cs_name = "";
                                 $cs_email = "";
                                 $cs_website = "";
                                 $cs_comment = "";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" value="<?php if(isset($cs_name)){echo $cs_name;}?>" name="email" class="form-control" placeholder="Email Id">
                                </div>
                                
                                <div class="form-group">
                                    <label for="website">Website: </label>
                                    <input type="text" name="website" value="<?php if(isset($cs_name)){echo $cs_name;}?>" id="website" class="form-control" placeholder="Website URL">
                                </div>
                                
                                <div class="form-group">
                                    <label for="comment">Comment : *</label>
                                    <textarea id="comment" cols="30" name="comment" rows="10" placeholder="Your Comment Should Be Here" class="form-control"> <?php if(isset($cs_name)){echo $cs_name;}?></textarea>
                                </div>
