<div class="col-md-4">
                        ...
                        <div class="col-xs-6">
                            <ul>
                               <?php
                                ...
                                if(mysqli_num_rows($c_run) > 0){                                    $count = 2;
            ...
            <div class="widgets">
                <div class="categories">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="web.whatsapp.com"><img src="img/whatsapp.png" alt="Whatsapp"></a>
                        </div>
                        <div class="col-xs-4">
                            <a href="facbook.com"><img src="img/facebook.png" alt="facebook"></a>
                        </div>
                        <div class="col-xs-4">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="gmail.com"><img src="img/gmail.png" alt="Gmail"></a>
                        </div>
                        <div class="col-xs-4">
                            <a href="email.com"><img src="img/Mail.png" alt="Email"></a>
                        </div>
                        <div class="col-xs-4">
